...
<div class="text-column">
	...
	<p>
		...
		recorded by Archeos Apps and how we use it.
	</p>
	...
	<p>
		...
		website with regards to the information that they shared and/or collect in Archeos Apps. This
	...
	<p>
		Archeos Apps follows a standard procedure of using log files. These files log visitors when they
	...
	<p>
		Like any other website, Archeos Apps uses "cookies". These cookies are used to store information
	...
	<p>
		...
		that are used in their respective advertisements and links that appear on Archeos Apps, which
	...
	<p>
		Note that Archeos Apps has no access to or control over these cookies that are used by
	...
	<p>
		Archeos Apps's Privacy Policy does not apply to other advertisers or websites. Thus, we are
	...
	<p>
		Archeos Apps does not knowingly collect any Personal Identifiable Information from children
	...
	<pre>We only collect the information you provide (name, email, username and password). All of its information is stored in Europe, regardless of the country where you live and we are willing if you contact me by email to delete all of the information from our servers. Your data is not accessed by humans or resold. They just allow the application to function properly and provide minimum comfort for you.</pre>
</div>
