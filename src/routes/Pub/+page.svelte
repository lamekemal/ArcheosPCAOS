...
<div class="text-column">
	...
	<pre>Please contact me at handill@pm.me, if you want anything. We only collect advertising identifiers to display the ad. No data is stored on our server. The advertising service is Google. THANKS</pre>
</div>
