    ...
    <div class="w-75 position-absolute top-0 start-50 translate-middle-x ">
      <div class="card m-4">
        ...
        <div class="card-body">
          ...
          <div>
            Nous nous engageons à vous offrir un droit d’opposition aux
            informations émises et sommes disposé à fornir les information et la
            totalité du code sources si vous estimez que certaines informations
            sont collectés.
          </div>
          <div>
            ...
            utilisées à certaines fins m entionnées lors de la collecte.
          </div>
          <div>
            <br />
          </div>
          ...
          <div>Législation: Publique en Europe</div>
          <div>
            <br />
          </div>
          <div></div>
